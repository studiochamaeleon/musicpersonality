...
export function createOgPng(hostScores: number[], matchScore?: number | null) {
  ...
  drawText(raw, matchScore === null || matchScore === undefined ? 'FRIEND INVITE' : 'OUR MUSIC MATCH', 930, 84, 3, 3);
